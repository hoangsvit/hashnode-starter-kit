...
const Lightbox = ({ isOpen, imageUrl, alt, onClose }: LightboxProps) => {
	...
	useEffect(() => {
		if (isOpen && showHelp && !isMobile) {
			// Only show help on desktop
	...
	return createPortal(
		<div
			className="lightbox-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm"
			onClick={onClose}
			onMouseUp={handleMouseUp}
			onMouseLeave={handleMouseUp}
		>
			<div className="lightbox-content relative max-h-[90vh] max-w-[90vw]">
				...
				<div className="overflow-hidden" onClick={(e) => e.stopPropagation()} onWheel={handleWheel}>
					<div
						className="relative"
						style={{
